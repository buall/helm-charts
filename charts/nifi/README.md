...
{{- if .Values.properties.webProxyHost }}
        # Update nifi.properties for web ui proxy hostname
  prop_replace nifi.web.proxy.host {{ template "apache-nifi.fullname" . }}.{{ .Release.Namespace }}.svc:{{.Values.service.httpsPort}},{{ template "apache-nifi.fullname" . }}.{{ .Release.Namespace }}.svc.cluster.local:{{.Values.service.httpsPort}},{{ template "apache-nifi.fullname" . }}.{{ .Release.Namespace }}:{{.Values.service.httpsPort}},{{ .Values.properties.webProxyHost }}
        {{- else }}
  prop_replace nifi.web.proxy.host {{ template "apache-nifi.fullname" . }}.{{ .Release.Namespace }}.svc:{{.Values.service.httpsPort}},{{ template "apache-nifi.fullname" . }}.{{ .Release.Namespace }}.svc.cluster.local:{{.Values.service.httpsPort}},{{ template "apache-nifi.fullname" . }}.{{ .Release.Namespace }}:{{.Values.service.httpsPort}}
{{- end }}
```
